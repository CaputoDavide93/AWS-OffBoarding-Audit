...
Account IDs and IP addresses are salted and hashed before anything leaves
your machine by default; `--no-redact` sends them in clear. Web search is
off unless you add `--search`.
